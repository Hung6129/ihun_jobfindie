...
import 'package:ihun_jobfindie/features/course/presentation/bookmark/views/bookmark_page.dart';
...
import '../course/presentation/search/views/search_page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return ZoomDrawer(
      ...
      angle: -5,
      drawerShadowsBackgroundColor: Palettes.textBlack,
      menuScreenOverlayColor: Palettes.textBlack,
      menuBackgroundColor: Palettes.textBlack,
      mainScreen: getPages(),
      menuScreen: Builder(
        builder: (context) {
          return MenuPage(
